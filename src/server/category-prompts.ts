...
export const categoryGenerationContexts = {
  ...
  'tv-series':
    'Television series: dramas, comedies, sitcoms, animated and streaming series, their characters, actors, creators and plots, mostly international. Not feature films, and Israeli TV belongs to the Israeli culture category.',
  music:
